...
# with command line options: --python_filename JME-RunIISummer20UL17MiniAODv2-00002_1_cfg.py --eventcontent MINIAODSIM --customise Configuration/DataProcessing/Utils.addMonitoring --datatier MINIAODSIM --fileout file:JME-RunIISummer20UL17MiniAODv2-00002.root --conditions 106X_mc2017_realistic_v9 --step PAT --procModifiers run2_miniAOD_UL --nThreads 4 --geometry DB:Extended --filein file:JME-RunIISummer20UL17RECO-00002.root --era Run2_2017 --runUnscheduled --no_exec --mc -n 10000
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:JME-RunIISummer20UL17RECO-{}.root'.format(options.chunknum)),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JME-RunIISummer20UL17MiniAODv2-{}.root'.format(options.chunknum)),
